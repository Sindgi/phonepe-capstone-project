...
if SELECT == "About":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\Admin\PycharmProjects\pythonProject\phone\phonepe.jpg"),width = 300)
        st.write("---")
        st.markdown("""
    ...
    with col1:
        ...
        with open(r"C:\Users\Admin\PycharmProjects\pythonProject\phone\phonepe\annual report.pdf","rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT",data,file_name="annual report.pdf")
    with col2:
        st.image(Image.open(r"C:\Users\Admin\PycharmProjects\pythonProject\phone\phonepe.jpg"),width = 800)
